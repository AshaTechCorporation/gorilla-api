...
class UserController extends Controller
{
    ...
    public function getPage(Request $request)
    {
        ...
        $col = array('id','permission_id','username', 'name', 'email', 'phone', 'image', 'status', 'create_by', 'update_by', 'created_at', 'updated_at');

        $orderby = array('','permission_id', 'image', 'name', 'email', 'phone', 'username', 'create_by', 'status');
