...
class ShelfController extends Controller
{
    ...
    {
        $Item = Shelf::where('area_id',$id)->get();
    ...
    public function getPage(Request $request)
    {
        ...
        $col = array('id', 'name', 'area_id', 'detail', 'image', 'create_by', 'update_by', 'created_at', 'updated_at');

        $orderby = array('', 'name', 'area_id', 'detail', 'image', 'create_by');

        $D = Shelf::where('area_id',$area_id)->select($col);
        ...
        if ($d->isNotEmpty()) {
            ...
            for ($i = 0; $i < count($d); $i++) {
                ...
                $d[$i]->area = Area::find($d[$i]->area_id)->first();
    ...
    public function show($id)
    {
        ...
        if (!empty($Item)) {
            ...
            $Item['floors'] = Floor::where('shelve_id', $Item['id'])
