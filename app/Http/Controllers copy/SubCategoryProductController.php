...
class SubCategoryProductController extends Controller
{
    ...
    public function getPage(Request $request)
    {
        ...
        $col = array('id', 'prefix', 'category_product_id', 'name', 'create_by', 'update_by', 'created_at', 'updated_at');

        $orderby = array('', 'prefix', 'category_product_id', 'name', 'create_by');

        $D = SubCategoryProduct::select($col);

        if (isset($category_id)) {
            $D->where('category_product_id', $category_id);
        }
     ...
     *
     * @param  \App\Models\SubCategoryProduct  $SubCategoryProduct
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
        ...
        if ($Item) {
            $Item->products = Products::where('category_product_id', $Item->id)->get();
        }
